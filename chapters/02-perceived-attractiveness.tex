...
A positive value of $\bar{a}(s, t, c)$ indicates that the stimulus is conventionally attractive in that setting; a negative value indicates that it is conventionally repulsive; and a value near $0$ indicates that the population is effectively indifferent or divided.
